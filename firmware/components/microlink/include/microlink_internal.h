...
/* DERP */
#define ML_DERP_REGION          CONFIG_ML_DERP_REGION  /* São Paulo (region 11) */
#define ML_DERP_HOST            "derp11e.tailscale.com"
...
#define ML_STUN_PRIMARY_HOST    "derp11e.tailscale.com"
...
struct microlink_s {
    ...
    uint32_t stun_primary_ip;       /* derp11e.tailscale.com resolved IPv4 */
    ...
    uint8_t stun_primary_ip6[16];   /* derp11e.tailscale.com resolved IPv6 */
    ...
    /* Reserved storage for future local configuration overrides. */
